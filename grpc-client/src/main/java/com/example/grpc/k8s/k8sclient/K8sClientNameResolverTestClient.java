...
public class K8sClientNameResolverTestClient {
...
//		String target = System.getenv("ECHO_SERVICE_TARGET");
		...
		nameResolverRegistry.register(new K8sClientNameResolverProvider());
...
//					.build();
			...
			channel = ManagedChannelBuilder.forTarget(target).usePlaintext().intercept(new HelloClientInterceptor())
					.build();
		}
